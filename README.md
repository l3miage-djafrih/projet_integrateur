...
Après la génération des jeux de données, nous avons quelques adresses non accessibles, alors on a éviter de les stocker dans la matrice, et garder que les adresses atteignables.
Cela se fait grâce au calcul de l'attribut snap distance qui représente la distance entre l'adresse et la route la plus proche, si sa valeur est grande alors on l'enlève de la matrice, c'est pour ça qu'on a moins d'adresses dans les fichiers du dataset : 
50 → 47
100 → 96
200 → 187
400 → 377
